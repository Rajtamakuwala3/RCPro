...
"[project]/node_modules/@chakra-ui/react/dist/esm/hooks/use-list-collection.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function useListCollection(props) {
    ...
    const create = (items)=>{
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ark$2d$ui$2f$react$2f$dist$2f$components$2f$collection$2f$list$2d$collection$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createListCollection"])({
            ...collectionOptions,
            items
        });
    };
    const [collection, setCollectionImpl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "useListCollection.useState": ()=>create(limit != null ? initialItems.slice(0, limit) : initialItems)
    }["useListCollection.useState"]);
    const setCollection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$hooks$2f$use$2d$callback$2d$ref$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallbackRef"])({
        "useListCollection.useCallbackRef[setCollection]": (collection2)=>{
            setCollectionImpl(limit == null ? collection2 : collection2.copy(collection2.items.slice(0, limit)));
        }
    }["useListCollection.useCallbackRef[setCollection]"]);
    return {
        collection,
        filter: (inputValue)=>{
            if (!filter) return;
            let filtered = create(initialItems).filter((itemString)=>filter(itemString, inputValue));
            setCollection(filtered);
        },
        set: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$hooks$2f$use$2d$callback$2d$ref$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallbackRef"])({
            "useListCollection.useCallbackRef": (items)=>{
                setCollection(create(items));
            }
        }["useListCollection.useCallbackRef"]),
        reset: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$hooks$2f$use$2d$callback$2d$ref$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallbackRef"])({
            "useListCollection.useCallbackRef": ()=>{
                setCollection(create(initialItems));
            }
        }["useListCollection.useCallbackRef"]),
        clear: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$hooks$2f$use$2d$callback$2d$ref$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallbackRef"])({
            "useListCollection.useCallbackRef": ()=>{
                setCollection(create([]));
            }
        }["useListCollection.useCallbackRef"]),
        insert: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$hooks$2f$use$2d$callback$2d$ref$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallbackRef"])({
            "useListCollection.useCallbackRef": (index, ...items)=>{
                setCollection(collection.insert(index, ...items));
            }
        }["useListCollection.useCallbackRef"]),
        insertBefore: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$hooks$2f$use$2d$callback$2d$ref$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallbackRef"])({
            "useListCollection.useCallbackRef": (value, ...items)=>{
                setCollection(collection.insertBefore(value, ...items));
            }
        }["useListCollection.useCallbackRef"]),
        insertAfter: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$hooks$2f$use$2d$callback$2d$ref$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallbackRef"])({
            "useListCollection.useCallbackRef": (value, ...items)=>{
                setCollection(collection.insertAfter(value, ...items));
            }
        }["useListCollection.useCallbackRef"]),
        remove: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$hooks$2f$use$2d$callback$2d$ref$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallbackRef"])({
            "useListCollection.useCallbackRef": (...itemOrValues)=>{
                setCollection(collection.remove(...itemOrValues));
            }
        }["useListCollection.useCallbackRef"]),
        move: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$hooks$2f$use$2d$callback$2d$ref$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallbackRef"])({
            "useListCollection.useCallbackRef": (value, to)=>{
                setCollection(collection.move(value, to));
            }
        }["useListCollection.useCallbackRef"]),
        moveBefore: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$hooks$2f$use$2d$callback$2d$ref$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallbackRef"])({
            "useListCollection.useCallbackRef": (value, ...values)=>{
                setCollection(collection.moveBefore(value, ...values));
            }
        }["useListCollection.useCallbackRef"]),
        moveAfter: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$hooks$2f$use$2d$callback$2d$ref$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallbackRef"])({
            "useListCollection.useCallbackRef": (value, ...values)=>{
                setCollection(collection.moveAfter(value, ...values));
            }
        }["useListCollection.useCallbackRef"]),
        reorder: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$hooks$2f$use$2d$callback$2d$ref$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallbackRef"])({
            "useListCollection.useCallbackRef": (from, to)=>{
                setCollection(collection.reorder(from, to));
            }
        }["useListCollection.useCallbackRef"]),
        append: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$hooks$2f$use$2d$callback$2d$ref$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallbackRef"])({
            "useListCollection.useCallbackRef": (...items)=>{
                setCollection(collection.append(...items));
            }
        }["useListCollection.useCallbackRef"]),
        prepend: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$hooks$2f$use$2d$callback$2d$ref$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallbackRef"])({
            "useListCollection.useCallbackRef": (...items)=>{
                setCollection(collection.prepend(...items));
            }
        }["useListCollection.useCallbackRef"]),
        update: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$hooks$2f$use$2d$callback$2d$ref$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallbackRef"])({
            "useListCollection.useCallbackRef": (value, item)=>{
...
function createOverlay(Component, options) {
    ...
    function Viewport() {
        const overlays = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSyncExternalStore"])(subscribe, getSnapshot, getSnapshot);
...
//# sourceMappingURL=node_modules_%40chakra-ui_react_dist_esm_89d8fcb7._.js.map